...
<main id="atualizar_recall" class="d-flex flex-column flex-fill">
    <div class="row flex-grow-1 g-0 m-0" style="height: 100px;"> 
        ...
        <div class="col-12 col-lg-7 p-3 h-lg-100" >
            ...
            <form class="d-flex flex-column flex-grow-1 h-100"
                data-form-type="ajax"
                data-form-target="#atualizar_recall_message"
                ...
                <div class="card h-100">
                    <div class="card-header">
                        ...
                        <small class="card-subtitle mb-2 text-muted">
                            <i class="bi bi-info-circle me-1"></i>Por favor, tenha cuidado ao realizar esta ação. Recomendamos que execute o procedimento de <code>Atualizar Recall</code> com cautela.
                        </small>
                    </div>
                    <div class="card-body overflow-auto">
                        <div class="row">
    
                            <div id="atualizar_recall_message" class="col-12"></div>
        ...
        <div class="col-12 col-lg-5 p-3 ps-lg-0 h-lg-100" >
            ...
            <?php require_once('./pages/atualizar_recall/historico.php') ?>
